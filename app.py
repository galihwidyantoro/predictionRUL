...
class FileUpload(object):
    ...
    def run(self):
        ...
        st.title('Prediksi Remaining Useful Life Booster Pump 203A')
        ...
        HIlatih = HIlatih.drop(['index'], axis=1)
        HIlatih['Kondisi Health Index']=HIuji['HI']
        HIlatih['Prediksi RUL']=HIlatih['HI_poli']

        st.divider()
        st.header("Prediksi Remaining Useful Life")
        ...
        plost.line_chart(
            data= HIlatih,
            x='Waktu',
            y=('Prediksi RUL','Kondisi Health Index')
        )
        st.divider()
